...
class UtilsTests(unittest.TestCase):
  ...
  def notest01_bounding_box_py(self):
    ...
    self.assertEqual(bb.bottomright, (29,39))

    # check the scaling functionality
    sbb = bb.scale(0.5)
    self.assertEqual(sbb.topleft, (-5, 0))
    self.assertEqual(sbb.bottomright, (14,19))
    sbb = bb.scale(0.84)
    self.assertEqual(sbb.topleft, (-8, 0))
    self.assertEqual(sbb.bottomright, (25,33))
    ...
    self.assertEqual(bb3.bottomright, (29,39))
  ...
  def test02_bounding_box_cpp(self):
    ...
    self.assertEqual(sbb.bottomright, (49,59))
    sbb = bb.scale(0.84)
    self.assertEqual(sbb.topleft, (-8,0))
    self.assertEqual(sbb.bottomright, (24,33))
  ...
  def test03_mirror(self):
    ...
    self.assertEqual(mirrored.bottomright[1], 39)
    ...
    x = image[bb.topleft[0]:bb.bottomright[0]+1, bb.topleft[1]:bb.bottomright[1]+1]
    y = mirrored_image[mb.topleft[0]:mb.bottomright[0]+1, mb.topleft[1]:mb.bottomright[1]+1]
