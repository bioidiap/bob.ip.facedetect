...
//    .def(init<const blitz::TinyVector<int,2>&, std::vector<bob::ip::LBP> >((arg("self"), arg("patch_size"), arg("extractors")), "Uses the given list of LBP extractors."))
    ...
    .def("prepare", &FeatureExtractor::prepare<double>, (arg("self"), arg("image")), "Take the given image to perform the next extraction steps")
    .def("prepare", &FeatureExtractor::prepare<uint8_t>, (arg("self"), arg("image")), "Take the given image to perform the next extraction steps")
