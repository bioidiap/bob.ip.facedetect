...
def main(command_line_arguments = None):
  ...
  sampler = Sampler(patch_size=args.patch_size, scale_factor=args.scale_base, lowest_scale=args.lowest_scale, distance=args.distance, similarity_thresholds=args.similarity_thresholds, mirror_samples=args.mirror_samples, cpp_implementation=args.lbp_cpp_implementation, number_of_parallel_threads=args.parallel)
