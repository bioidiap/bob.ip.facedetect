...
class TrainingSet:
  ...
  def __init__(self, sampler, cascade, patch_size = (96,80), offset = (20,10), training_image_directory = "training_images"):
  ...
  def add_image(self, image_file_name, annotations, image_file):
    ...
    if os.path.exists(detected_image_file):
      ...
      scaled_annotation = {key:geon(value, eyes[0], eyes[1]) for key,value in annotations[0].iteritems()}
