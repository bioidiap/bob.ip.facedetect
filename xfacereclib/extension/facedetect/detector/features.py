...
class LBPFeatures:
  ...
  def __init__(self, patch_size = (24,20), model = None, lbp_extractors = None, **kwargs):
    ...
    if lbp_extractors is not None:
      ...
      self.m_lbps = [bob.ip.LBP(8, float(ry), float(rx), **kwargs) for ry in range(1, patch_size[0] / 2) for rx in range(1, patch_size[1] / 2)]
  ...
  def init(self):
    ...
    self._complete_length = sum(feature_lengths)
  ...
  def number_of_features(self):
    """Returns the number of features generated by this extractor."""
